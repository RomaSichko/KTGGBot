class MessagesText:
    ...
    RESET_PASSWORD_WITHOUT_ACC_CHOICE_VERIFY_TYPE = ("Для зміни пароля, потрібно дізнатися твої дані, "
                                                     "будь ласка, обери тип верифікації")
    ...
    MESSAGE_STUDENT_TICKET_RESET_TYPE = (
        "Ти обрав тип верифікації за допомогою студентького квитка. "
    ...
    MESSAGE_ID_CARD_RESET_TYPE = (
        "Ти обрав тип верифікації за допомогою id-картки. Надішли, будь ласка, свої дані в такому форматі:\n"
